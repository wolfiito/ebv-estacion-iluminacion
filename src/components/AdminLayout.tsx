      ...
      <nav className="flex flex-wrap sm:flex-nowrap items-center gap-2 border border-white/10 rounded-2xl p-1.5 bg-black/40 mb-10 shadow-inner w-full max-w-3xl relative z-10 overflow-x-auto">
        {navLinks.map((link) => (
          <NavLink
            ...
            className={({ isActive }) => `flex-1 min-w-[150px] flex items-center justify-center gap-2 px-3 md:px-6 py-3.5 rounded-xl text-center font-bold transition-all whitespace-nowrap ${isActive
